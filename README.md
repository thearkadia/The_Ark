...
The Ark is a portable computer we're developing to make it simple to participate in a Democracy. 
 ...
 If you want to be involved sign up for the [newsletter,] (https://thearkadia.com/pages/newsletter) [submit an idea\issue](https://github.com/thearkadia/The_Ark/issues) or a [pull request](https://github.com/thearkadia/The_Ark/pulls).
